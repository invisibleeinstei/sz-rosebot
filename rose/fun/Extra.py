...
◇️ ━━━━━━━━━ ◇️
👨‍💻 **Generated By**: [ᴀʟ ᴋᴜᴘᴘɪʏᴀ ᴘʀᴏᴛᴇᴄᴛᴏʀ 🪶](https://t.me/apealkuppiya)
🙋‍♂️ **Requestor** : {}
◇️ ━━━━━━━━━ ◇️
**©2022** [ᗩ/し ᏦᑌᑭᑭᏆᎩᗩᵀᴹ 🐣](http://t.me/apealkuppiya) **ᴀʟʟ ʀɪɢʜᴛꜱ ʀᴇꜱᴇʀᴠᴇᴅ ⚠️**
"""
...
picmebtns = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("✘【SZ™】Support Chat", url="https://t.me/apealkuppiya"),
                    InlineKeyboardButton("✘【SZ™】Updates Channel", url="https://t.me/alevelkuppiya1")       
                ],         
            ]
        )
pm = """
...
""", show_alert=True)
    ...
    if mode == "pm":
        try:
            ...
            await query.answer("Please First Start This 👉 @alkuppiyaprotectorbot")
            print(str(e))
            if os.path.exists(photo):os.remove(photo)     
