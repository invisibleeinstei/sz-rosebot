...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/c1b6243f41419dffba9b5.jpg",
...
async def alive_function(answers):
    ...
    msg = f"""
**[ᗩ/し ᏦᑌᑭᑭᏆᎩᗩᵀᴹ 🐣](https://t.me/apealkuppiya):**
**System Stats:**
**MainBot:** `{bot_state}`
...
[->> Shorter the Way, Faster you Go! 🏃‍♂️](https://t.me/apealkuppiya) 
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def logo_func(answers, text):
    ...
    fname = "alkuppiyaprotectorbot.png"
    img.save(fname, "png")
    answers.append(
            InlineQueryResultPhoto(
                photo_url=murl,
